...
var appxManifest = File("./src/Reunification.UWP/Package.appxmanifest");
var appPackageDirectory = Directory("./src/Reunification.UWP/AppPackages");

Task("UWP")
    .IsDependentOn("UWP-Version")
	.Does(()=>
	{
        var uwpProject = File("./src/Reunification.UWP/Reunification.UWP.csproj");
		...
		MSBuild(uwpProject, settings =>
				settings
                    ...
                    .WithProperty("ProjectName", "Reunification")
...
Task("Install-Certificate")
    ...
    {            
        ...
        try
        {
            ...
            var cert = File("./src/Reunification.UWP/Reunification.UWP_TemporaryKey.pfx");
...
Task("Zip-Bundle")
    ...
    .Does(() =>
    {
        ...
        var appPackageDirectories = GetDirectories("./src/**/AppPackages/Reunification_*");
        ...
        if(!appPackageDirectories.Skip(1).Any())
        {
            ...
            Zip(appPackageDirectories.FirstOrDefault(), "./artifacts/uwp/Reunification.UWP_" + BuildVersion.AssemblySemVer + ".zip");
        }
    });